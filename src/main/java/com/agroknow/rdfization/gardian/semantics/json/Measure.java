...
public class Measure {
    ...
    public Measure(String id, String iri, String short_form, String obo_id, String label, String ontology_name, String ontology_prefix, String type, boolean is_defining_ontology, JsonArray description) {
        this.id = id;
        this.iri = iri;
    ...
    public void setIs_defining_ontology(boolean is_defining_ontology) {
        this.is_defining_ontology = is_defining_ontology;
    }
